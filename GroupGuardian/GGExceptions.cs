...
namespace GroupGuardian
{
    public class TelegramException : Exception
    {
        ...
        public TelegramException(int err)
        : base(GGExceptions.errors[err])
        {
            code = err;
        }
    }
    ...
    {
        public WebhookEnabledException() : base(409) { }
    }
    class GGExceptions
    {
        ...
        public static Dictionary<int, string> errors = new Dictionary<int, string> {
            ...
            {409, "Conflict: can't use getUpdates method while webhook is active"}, //user blocked the bot
